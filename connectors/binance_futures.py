...
class BinanceFuturesClient:
    ...
    def place_order(self, contract: Contract, side: str, quantity: float, order_type, price=None, tif=None):
        data = dict()
        data['symbol'] = contract.symbol
        data['side'] = side
    ...
    def on_open(self, ws):
        logger.info("Binanace Connection Opened")

        self.subscribe_channel("BTCUSDT")

    def on_close(self, ws):
        logger.warning("Binanace Websocket Connection Closed")
